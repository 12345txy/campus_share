...
public class PostLikeController {
    ...
    public PostLikeController(PostLikeService postLikeService, UserService userService,LikeService likeService) {
    ...
    public Result<Integer> getCommentLikeCount(@PathVariable Long commentId) {
    ...
    public Result<Boolean> likeComment(@PathVariable Long commentId) {
        ...
        boolean success = postLikeService.likeComment(commentId, currentUser.getId());
        if (success) {
            return Result.success(true);
        } else {
            return Result.error(400, "点赞失败，可能已点赞");
    ...
    public Result<Boolean> unlikeComment(@PathVariable Long commentId) {
        ...
        boolean success = postLikeService.unlikeComment(commentId, currentUser.getId());
        if (success) {
            return Result.success(true);
        } else {
            return Result.error(400, "取消点赞失败");
