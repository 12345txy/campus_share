...
public class PostFavoriteController {
    ...
    public PostFavoriteController(PostFavoriteService postFavoriteService, UserService userService) {
    ...
    public Result<IPage<Post>> getMyFavorites(
        ...
        IPage<Post> favorites = postFavoriteService.getFavoritePostsByUserId(pageParam, currentUser.getId());
